...
\begin{frame}{Đồ thị de Bruijn}
    ...
    Mỗi đỉnh được gán nhãn bởi một đoạn có chiều dài $k-1$ và cạnh có hướng tồn tại giữa hai đỉnh đại diện cho một trong đoạn có chiều dài $l$.
...
\begin{frame}{So sánh chuỗi DNA với đồ thị de Bruijn}
                ...
                \begin{algorithm}[H]
                    ...
                    \ForEach{o\_edge $\in$ out\_edges}{
                        \If{o\_edge.visited < o\_edge.multiplicities}{
                            o\_edge.multiplicities $\gets$ o\_edge.multiplicities + 1\;
                            path.add(o\_edge)\;
